...
public:
    ...
    [[nodiscard]] auto devicePtr() -> T* { return m_ptr; }
    [[nodiscard]] auto devicePtr() const -> const T* { return m_ptr; }
    [[nodiscard]] auto size() const -> size_t { return m_count; }
    [[nodiscard]] auto bytes() const -> size_t { return m_count * sizeof(T); }
    [[nodiscard]] bool valid() const { return m_ptr != nullptr; }
